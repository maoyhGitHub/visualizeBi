...
<template>
  <div
    class="de-tree-list-class"
  >
    <div class="de-tree-list-search" style="display: none">
      <el-input
        ref="de-tree-list"
        v-model="keyWord"
...
export default {
  ...
  computed: {
    ...
    cssArr() {
      const { brColor, wordColor, innerBgColor } = this.customStyle
...
/deep/ .el-tree {
  .el-tree-node.is-current {
    background-color: #f5f7fa7a !important;
  }
