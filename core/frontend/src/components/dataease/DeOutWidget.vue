      ...
      >
        <div class="condition-content-container">
          <div class="first-element">
            <div
              :class="showStyle === true ? 'first-element-grid-container': ''"
...
export default {
  ...
  data() {
    return {
      needRefreshComponents: ['de-select', 'de-select-grid', 'de-select-tree', 'de-tree-list'],
      inputMaxSize: 46,
      inputLargeSize: 42,
      inputSmallSize: 38,
      inputMiniSize: 32,
  ...
  computed: {
    ...
    deSelectGridBg() {
      if (this.element.component !== 'de-select-grid' && this.element.component !== 'de-tree-list') return null
    ...
    isFilterComponent() {
      return ['de-select', 'de-tree-list', 'de-select-grid', 'de-date', 'de-input-search', 'de-number-range', 'de-select-tree'].includes(this.element.component)
    },
    ...mapState([
      'curComponent',
      'previewCanvasScale'
  ...
  created() {
    if (this.element.component === 'de-select-grid' || this.element.component === 'de-tree-list') {
      this.showStyle = true
    }
  ...
  methods: {
    ...
    handlerPositionChange(val) {
      ...
      if (vertical !== 'top' && this.element.component !== 'de-select-grid' && this.element.component !== 'de-tree-list') {
