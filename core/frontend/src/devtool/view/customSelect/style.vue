    ...
    <el-row>
      ...
      <el-collapse v-model="attrActiveNames" class="style-collapse">
        <el-form ref="styleForm" :model="styleForm" label-width="80px" size="mini" >
          <el-collapse-item name="font" title="主题颜色">
<!--            <el-radio-group-->
...
<!--            </el-radio-group>-->
            <el-form-item label="边框颜色" class="form-item">
              <el-color-picker v-model="styleForm.borderColor" show-alpha class="color-picker-style" :predefine="predefineColors" @change="changeAttributeStyle" />
            </el-form-item>
