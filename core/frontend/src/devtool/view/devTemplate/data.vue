  ...
  <div>
    ...
    <el-row class="padding-lr">
      <span style="width: 80px;text-align: right;">
        <span>省维度一/</span>/<span>{{ $t('chart.dimension') }}</span>
      </span>
      <!--  -->
      <draggable
      ...
      >
        <transition-group class="draggable-group">
          <dimension-item
            ...
            @onDimensionItemRemove="provinceXaxisRemove"
    ...
    >
      <span class="data-area-label">
        <span>绑定战区</span>/<span>{{ $t('chart.dimension') }}</span>
      </span>
      <draggable
        v-model="warzone"
        group="drag"
...
export default {
  ...
  methods: {
    ...
    // 分割线 以上不变
    calcData(cache) {
      this.view.xaxis = [...this.provinceXaxis, ...this.warzone]// 经纬度信息
