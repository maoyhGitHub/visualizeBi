  ...
  <div class="top-nav">
    ...
    >
      <!--      <svg-icon
            ...
            >-->
      <div style="float: left;margin-top: 5px;"> <img src="../../assets/logo.png" alt=""></div>
      <div style="float: left;padding-bottom: 10px">数据可视化平台</div>
    </div>
    <el-menu
      class="de-top-menu"
      mode="horizontal"
...
export default {
  ...
  created() {
    this.f_route = this.permission_routes.filter(
      item => (item.path !== '/wizard')
    )
    this.loadUiInfo()
  },
  beforeCreate() {
  ...
  methods: {
    ...
    setSidebarHide(route) {
      const hidePaths = ['/person-info', '/person-pwd', '/about', '/implantPlane']
