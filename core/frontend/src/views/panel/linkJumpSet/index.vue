        ...
        >
          <el-row v-if="linkJumpInfo">
            ...
            <el-row style="margin-top: 10px;height: 30px">
              ...
              <el-col :span="16">
                ...
                >
                  ...
                  <el-radio label="_open">弹窗</el-radio>
                </el-radio-group>
              </el-col>
            </el-row>
            <el-row v-if="linkJumpInfo.jumpType==='_open'">
              <el-col
                :span="4"
                style="margin-left: 20px"
              >弹窗设置：
              ...
              <el-col :span="15">
                <el-radio-group @change="changeHandler"
                                v-model="linkJumpInfo.isFullscreen"
                                size="mini">
                  <el-radio label="defaultSize">默认尺寸</el-radio>
                  <el-radio label="otherSize">其他尺寸</el-radio>
                  <el-radio label="isFullscreen">全屏</el-radio>
                </el-radio-group>
              </el-col>
            </el-row>
            <el-row v-if="linkJumpInfo.jumpType==='_open' && linkJumpInfo.isFullscreen==='otherSize'">
              <div style="margin-left: 20px; margin-top: 6px">
                <el-col :span="4">尺寸设置：</el-col>
                <el-col :span="1">宽:</el-col>
                <el-col :span="8">
                  <el-input
                    type="number"
                    size="mini"
                    v-model="linkJumpInfo.dialogWidth"
                  >
                ...
                <el-col :span="8">
                  <el-input
                    type="number"
                    size="mini"
                    v-model="linkJumpInfo.dialogHeight"
                  >
                    <template slot="append">%</template>
                  </el-input>
                </el-col>
            ...
            >
              ...
              <el-row class="bottom" :style="{marginTop: marginTop + 'px'}">
                <el-button
  ...
  methods: {
    ...
    save() {
      ...
      this.linkJumpInfoArray.forEach(jumpInfo => {
        ...
        if (jumpInfo.isFullscreen === 'otherSize' && (jumpInfo.dialogHeight === null || jumpInfo.dialogHeight === ''
          || jumpInfo.dialogWidth === null || jumpInfo.dialogWidth === '')) {
          this.$message.warning('弹窗设为‘其他尺寸’时，宽高不能为空')
          type = false;
        }
      })
      if (type) {
    ...
    nodeClick(data, node) {
      ...
      if (!this.linkJumpInfo.isFullscreen) {
        this.linkJumpInfo.isFullscreen = 'defaultSize'
      }
      if (this.linkJumpInfo.targetPanelId) {
        this.getPanelViewList(this.linkJumpInfo.targetPanelId)
      }
      if (this.linkJumpInfo.isFullscreen === 'otherSize') {
        this.marginTop = -56;
      }else {
        this.marginTop = -22;
      }
