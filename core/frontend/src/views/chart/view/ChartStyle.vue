<template>
  <el-row class="view-panel">
    <div
      v-if="!pluginShow && !devToolShow && properties.length === 0"
      class="no-properties"
    >
...
import DevToolStyleComponent from '@/devtool/pluginDev/style.vue'
...
export default {
  ...
  computed: {
    ...
    devToolShow() {
      return this.view.type && this.view.type === 'view-dev-tool'
    },
    markSelectorShow() {
