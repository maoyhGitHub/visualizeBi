...
export function saveTempStaticData(data) {
  return request({
    url: 'api/link/saveTempStaticData',
    method: 'post',
    loading: false,
    data
  })
...
export function updateTempStaticData(data) {
  return request({
    url: 'api/link/updateTempStaticData',
    method: 'post',
    loading: false,
    data
  })
...
export function getViewTable(id, hideMsg = false) {
  return request({
    url: 'api/link/getViewTable/' + id,
    loading: false,
    method: 'post',
    hideMsg: hideMsg
  })
...
export function importCustomExcel(data) {
  return request({
    url: 'api/link/importCustomExcel',
    loading: false,
    method: 'post',
    data
  })
