...
public class DataSetTableController {
    ...
    @ApiOperation("静态数据列表")
    @PostMapping("/staticDataList")
    public List<DataSetStaticData> staticDataList(@RequestBody DataSetStaticData param ) {
        return dataSetTableService.staticDataList(param);
    }
