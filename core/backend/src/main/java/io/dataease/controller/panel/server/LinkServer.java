...
public class LinkServer implements LinkApi {
    ...
    public DataSetStaticData saveTempStaticData(DataSetStaticData param) {
        return dataSetTableService.saveTempStaticData(param);
    }

    @Override
    public void updateTempStaticData(DataSetStaticData param) {
        dataSetTableService.updateTempStaticData(param);
    }

    @Override
    public List<Map<String, Object>> importCustomExcel(MultipartFile file, String tableId, String viewId) {
        DataSetStaticData param = new DataSetStaticData();
        param.setViewId(viewId);
        param.setTableId(tableId);
        return dataSetTableService.importCustomExcel(file, param);
    }
