...
public class PanelLinkJumpController {
    ...
    @ApiOperation("获取仪表板打开弹窗参数")
    @GetMapping("/queryPanelLinkJumpInfoParams/{linkJumpInfoId}")
    public PanelLinkJumpInfoParamsDTO queryPanelLinkJumpInfoParams(@PathVariable String linkJumpInfoId) {
        return panelLinkJumpService.queryPanelLinkJumpInfoParams(linkJumpInfoId);
    }
}
