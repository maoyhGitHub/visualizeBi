...
public class ShiroServiceImpl implements ShiroService {
    ...
    public Map<String, String> loadFilterChainDefinitionMap() {
        ...
        filterChainDefinitionMap.put("/iconCategory/findCategory", ANON);
        filterChainDefinitionMap.put("/api/link/saveTempStaticData", "link");
        filterChainDefinitionMap.put("/api/link/updateTempStaticData", "link");
        filterChainDefinitionMap.put("/api/link/importCustomExcel", "link");
        filterChainDefinitionMap.put("/api/link/getViewTable/**", "link");
