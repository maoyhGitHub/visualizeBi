            ...
            if (datasetRowPermissions.getFilterType().equalsIgnoreCase("logic")) {
                ...
                lists.forEach(chartCustomFilterDTO -> {
                    ...
                    if (datasetRowPermissions.getAuthTargetType().equalsIgnoreCase("sysParams")) {
                        chartCustomFilterDTO.setValue(values.get(chartCustomFilterDTO.getValue()));
                    }
                });
                dto.setFilter(lists);
                ...
                if (datasetRowPermissions.getAuthTargetType().equalsIgnoreCase("sysParams")) {
                    dto.setEnumCheckField(Arrays.asList(values.get(datasetRowPermissions.getEnumCheckField()).split(",").clone()));
                } else {
