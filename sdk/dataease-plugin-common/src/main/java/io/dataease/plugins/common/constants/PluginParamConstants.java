...
public interface PluginParamConstants {
    ...
    enum Type implements PluginParamConstants {
    ...
    enum Classify implements PluginParamConstants {
        MAIL("smtp"),
        BASE("base"),
        LDAP("ldap"),
        WECOM("wecom"),
    ...
    enum Registry implements PluginParamConstants {
        URL("registry.url"),
        REPO("registry.repo"),
    ...
    enum I18n implements PluginParamConstants {
    ...
    enum BASE implements PluginParamConstants {
        URL("base.url"),
    ...
    enum LDAP implements PluginParamConstants {
        URL("ldap.url"),
        DN("ldap.dn"),
    ...
    enum WECOM implements PluginParamConstants {
        CORPID("wecom.corpid"),
    ...
    enum DINGTALK implements PluginParamConstants {
    ...
    enum LARK implements PluginParamConstants {
        APPK_ID("lark.app_id"),
    ...
    enum LARKSUITE implements PluginParamConstants {
